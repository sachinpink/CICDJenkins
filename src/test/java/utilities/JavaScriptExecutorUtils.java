...
public class JavaScriptExecutorUtils {
	...
	public static void click(WebElement element,int seconds,WebDriver driver)
	{
	...
	public static void click(By locater,int seconds,WebDriver driver)
	{
		...
		waits.until(ExpectedConditions.elementToBeClickable(By.xpath("//a"))).click();
			
	}
	public static void actionDemo(WebElement element)
	{
		Actions act = new Actions(driver);
		Action action =act.moveToElement(element).click().keyUp(Keys.SHIFT)
				.sendKeys("hello")
				.keyUp(Keys.SHIFT)
	...
	public static void windowHandle(WebElement element)
	{
		...
		{
			if(!childWin.equals(paraentWindow))
			{
